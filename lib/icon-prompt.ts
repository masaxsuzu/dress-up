...
const CATEGORY_HINT: Record<ClothingCategory, string> = {
  ...
  outerwear:
    "Render this outer garment as if worn on an invisible body, ghost-mannequin style: " +
    "shoulders defined at the top, sleeves hanging straight down on both sides, " +
    "the garment closed at the front in its natural worn shape (buttoned, zipped, or naturally overlapping — do NOT cut out or leave the center axis empty). " +
  ...
  dress:
    ...
    "Front view, vertical orientation.",
  shoes:
    "Render this pair of shoes from a slight 3/4 front-side angle, both shoes flat on the floor side by side. " +
    "Both shoes are PARALLEL to each other and point in the SAME diagonal direction (do NOT splay them outward into a V-shape / ハの字). " +
    "Picture them like a typical product display shot. Both shoes fully visible at the same scale.",
  bag:
